...
import com.mediatek.nn.benchmark.NNTestList.TestName;

/**
 * NNAPI benchmark test.
 * To run the test, please use command
 *
 * adb shell am instrument -w com.mediatek.nn.benchmark/android.support.test.runner.AndroidJUnitRunner
 *
 */
