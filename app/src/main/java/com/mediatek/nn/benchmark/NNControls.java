...
public class NNControls extends Activity implements AdapterView.OnItemSelectedListener {
    protected static final String TAG = "NN_CONTROLS";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT < 30) {
            Log.d(TAG, "Preferred preference: " + com.mediatek.neuropilot.Platform.getPreferredInference());
        } else  {
            Log.d(TAG, "Preferred preference: " + com.mediatek.neuropilot_R.Platform.getPreferredInference());
        }
        spinner = (Spinner)findViewById(R.id.spinner);
        ArrayAdapter<String>adapter = new ArrayAdapter<String>(NNControls.this,
    ...
    Intent makeBasicLaunchIntent() {
        ...
        intent.putExtra("batchSize",batchSize);
        return intent;
    }
...
//                            "X,   " + df.format(r[ct]) + "IPS";
    ...
    private static final String[] paths = {"1","2", "4", "8","16"};
